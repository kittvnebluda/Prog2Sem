...
import com.itmo.itmoproject2023.Coordinates
...
class CustomConsole(private val invoker: Invoker) {
    companion object {
        ...
        fun createPerson(): Person {
            ...
            return Person(name!!, coordinates, birthday, height, weight, hairColor, location)
        }
        ...
        fun callBool(callback: Callback<String>) {
            if (callback.success)
